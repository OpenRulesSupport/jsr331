...
rem SKIP options
set OPTIONS=-DLP_SOLVER_OPTIONS="set limits time 12000 set limits stallnodes 1000 set limits gap 1.05 set heuristics emphasis aggressive"
set SOLVER=../org.jcp.jsr331.linear.scip/lib/jsr331.scip.jar;%LPCOMMON%

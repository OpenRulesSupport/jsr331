...
public abstract class PrimitiveConstraint extends Constraint {
	...
	public abstract int getNotConsistencyPruningEvent(Variable var);
	...
	public abstract int getNestedPruningEvent(Variable var, boolean mode);
	 ...
	 */
	public void setNotConsistencyPruningEvent(Variable var, int pruningEvent) {
	
			if (notConsistencyPruningEvents == null)
				notConsistencyPruningEvents = new Hashtable<Variable, Integer>();

...
public class GeostObject {
	 ...
	 */
	public final Variable duration;
	
	/**
	 * It specifies the end time of this object.
	 */
	public final Variable end;
	 ...
	 * constraint. 
	 * 
	 * @param id nonnegative unique id of this object. 
	 ...
	 * @param end 
	 */
	public GeostObject(int id, Variable[] coords, Variable shapeID, Variable start,
						Variable duration, Variable end) {
		super();
	 ...
	 */
	public final void onGround(Variable variable) {
	 ...
	 */
	public final void onUnGround(Variable variable){

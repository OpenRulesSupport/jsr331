...
public class XplusCeqZ extends PrimitiveConstraint implements Constants {

	static int IdNumber = 1;

	final static short type = addC;
	 ...
	 * @param z variable z.
	 */
	public XplusCeqZ(Variable x, int c, Variable z) {
		numberId = IdNumber++;
		X = x;
		C = c;
		Z = z;
	...
	public org.jdom.Element getPredicateDescriptionXML() {
		...
		predicate.setAttribute("name", Constants.id_addC + String.valueOf(C));
		...
		functional.setText("eq(add(" + X.id() + ","
	...
	public org.jdom.Element toXML() {
		...
		constraint.setAttribute("reference", Constants.id_addC + String.valueOf(C));

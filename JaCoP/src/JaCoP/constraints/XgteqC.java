...
public class XgteqC extends PrimitiveConstraint implements Constants {

	static int IdNumber = 1;

	final static short type = gtEqC;
	 ...
	 * @param c constant c.
	 */
	public XgteqC(Variable x, int c) {
		numberId = IdNumber++;
		numberArgs = 2;
		X = x;
		C = c;
	...
	public org.jdom.Element getPredicateDescriptionXML() {
		...
		predicate.setAttribute("name", Constants.id_gtEqC + String.valueOf(C));
		...
		functional.setText("ge(" + X.id() + "," + String.valueOf(C)	+ ")");
	...
	public org.jdom.Element toXML() {
		...
		constraint.setAttribute("reference", Constants.id_gtEqC + String.valueOf(C));

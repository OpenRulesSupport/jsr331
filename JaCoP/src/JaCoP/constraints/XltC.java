...
public class XltC extends PrimitiveConstraint implements Constants {

	static int IdNumber = 1;

	final static short type = ltC;
	...
	public org.jdom.Element getPredicateDescriptionXML() {
		...
		predicate.setAttribute("name", Constants.id_ltC + String.valueOf(C));
		...
		functional.setText("lt(" + X.id() + "," + String.valueOf(C) + ")");
	...
	public org.jdom.Element toXML() {
		...
		constraint.setAttribute("reference", Constants.id_lt + String.valueOf(C));

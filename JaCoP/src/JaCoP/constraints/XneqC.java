 ...
 * Constraints X #\= C
 * 
 * Doamin consistency is used.
 * 
 * @author Krzysztof Kuchcinski and Radoslaw Szymanek
 * @version 2.4
 */

public class XneqC extends PrimitiveConstraint implements Constants {

	static int IdNumber = 1;

	final static short type = nEqC;
	 ...
	 * @param c constant c.
	 */
	public XneqC(Variable x, int c) {
		numberId = IdNumber++;
		numberArgs = 2;
		X = x;
		C = c;
		cDom = new IntervalDomain(C, C);
	}
	...
	public org.jdom.Element getPredicateDescriptionXML() {
		...
		predicate.setAttribute("name", Constants.id_nEqC + String.valueOf(C));
		...
		functional.setText("ne(" + X.id() + "," + String.valueOf(C)	+ ")");
	...
	public boolean satisfied() {
		...
		// return Domain.domain.intersect(X.dom(), cDom).isEmpty();
	}
	...
	public org.jdom.Element toXML() {
		...
		constraint.setAttribute("reference", id_nEqC + String.valueOf(C));

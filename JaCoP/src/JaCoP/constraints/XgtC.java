...
public class XgtC extends PrimitiveConstraint implements Constants {

	static int IdNumber = 1;

	final static short type = gtC;
	...
	public org.jdom.Element getPredicateDescriptionXML() {
		...
		predicate.setAttribute("name", Constants.id_gtC + String.valueOf(C));
		...
		functional.setText("gt(" + X.id() + "," + String.valueOf(C) + ")");
	...
	public org.jdom.Element toXML() {
		...
		constraint.setAttribute("reference", Constants.id_gtC

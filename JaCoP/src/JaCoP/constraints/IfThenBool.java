...
public class IfThenBool extends PrimitiveConstraint implements Constants {

	static int IdNumber = 1;

	final static short type = ifthenbool;
	 ...
	 * @param z variable z.
	 */
	public IfThenBool(Variable x, Variable y, Variable z) {
	...
	public org.jdom.Element toXML() {
		...
		constraint.setAttribute("reference", id_ifthenbool);
	...
	static public Constraint fromXML(Element constraint, Store store) {
		...
		return new IfThenBool(store.findVariable(x), store.findVariable(y), store.findVariable(z));

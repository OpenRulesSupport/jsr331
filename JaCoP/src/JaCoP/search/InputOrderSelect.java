...
public class InputOrderSelect implements SelectChoicePoint {
	...
	public InputOrderSelect(Store store, 
		...
		this.searchVariables = new Variable[unique];
	...
	public int getChoiceValue() {
		...
		assert (searchVariables[currentIndex.value()].domain != null);
		
		return valueOrdering.indomain(searchVariables[currentIndex.value()].domain);

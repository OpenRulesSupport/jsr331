...
/**
 * 
 * It solves the PigeonHole problem. The problem
 * is how to assign n pigeons into n-1 holes in 
...
public class PigeonHole extends Example {
	...
	public void model() {
		...
		FDV[] numbers = new FDV[noPigeons];

		for (int i = 0; i < noPigeons; i++)
			numbers[i] = new FDV(store, "h" + (i + 1), 1, noPigeons - 1);

...
public class CalendarMen extends Example {
	...
	public void model() {
		...
		FDV first[] = new FDV[12];
		FDV last[] = new FDV[12];
		FDV sport[] = new FDV[12];

		for (int i = 0; i < 12; i++) {
			first[i] = new FDV(store, firstNames[i], 1, 12);
			last[i] = new FDV(store, lastNames[i], 1, 12);
			sport[i] = new FDV(store, sportNames[i], 1, 12);
		...
		FDV I_1_1 = new FDV(store, "c1_m", 1, 3);
		FDV I_1_2 = new FDV(store, "c1_m", 1, 3);
		FDV I_1_3 = new FDV(store, "c1_m", 1, 3);
		...
		FDV I_2_1 = new FDV(store, "c2_m", 1, 3);
		FDV I_2_2 = new FDV(store, "c2_m", 1, 3);
		FDV I_2_3 = new FDV(store, "c2_m", 1, 3);
		...
		FDV X1 = new FDV(store, "c2_m", 1, 12);
		FDV X2 = new FDV(store, "c2_m", 1, 12);
		FDV X3 = new FDV(store, "c2_m", 1, 12);
		...
		FDV D1 = new FDV(store, "c4_m", 1, 3);
		FDV D2 = new FDV(store, "c4_m", 1, 3);
		FDV D3 = new FDV(store, "c4_m", 1, 3);
		...
		FDV I_9_1 = new FDV(store, "c9_m", 1, 3);
		FDV I_9_2 = new FDV(store, "c9_m", 1, 3);
		FDV I_9_3 = new FDV(store, "c9_m", 1, 3);
		...
		FDV I_10_1 = new FDV(store, "c10_m", 1, 3);
		FDV I_10_2 = new FDV(store, "c10_m", 1, 3);
		FDV I_10_3 = new FDV(store, "c10_m", 1, 3);
		...
		FDV W1 = new FDV(store, "c10_m", 1, 12);
		FDV W2 = new FDV(store, "c10_m", 1, 12);
		FDV W3 = new FDV(store, "c10_m", 1, 12);
		...
		FDV K1 = new FDV(store, "c11_m", 1, 3);
		FDV K2 = new FDV(store, "c11_m", 1, 3);
		FDV K3 = new FDV(store, "c11_m", 1, 3);
		...
		FDV Q1 = new FDV(store, "c11_m", 1, 12);
		FDV Q2 = new FDV(store, "c11_m", 1, 12);
		FDV Q3 = new FDV(store, "c11_m", 1, 12);
		...
		FDV L1 = new FDV(store, "c12_m", 1, 3);
		FDV L2 = new FDV(store, "c12_m", 1, 3);
		FDV L3 = new FDV(store, "c12_m", 1, 3);
	...
	public void modelBasic() {
		...
		FDV firstname[] = new FDV[12];
		FDV surname[] = new FDV[12];
		FDV sport[] = new FDV[12];

		for (int i = 0; i < 12; i++) {
			firstname[i] = new FDV(store, firstnameID[i], 1, 12);
			surname[i] = new FDV(store, surnameID[i], 1, 12);
			sport[i] = new FDV(store, sportID[i], 1, 12);
		...
		FDV offset1 = new FDV(store, "offset1", 1, 5);
		FDV offset2 = new FDV(store, "offset2", 2, 10);

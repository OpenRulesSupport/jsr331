...
public class FilterBenchmarkXML {
	...
	public static void experiment1(FDstore store, 
		...
		if (result) {
			store.toXCSP2_0();
			store.finalizeXCSP2_0(-1, "./", filter.name() + "-no(" + addNum + ","
					+ mulNum + ")-del(" + filter.addDel() + "," + filter.mulDel()
					+ ").xml");
		}
	}
	...
	public static void experiment1C(FDstore store, 
		...
		if (result) {
			store.toXCSP2_0();
			store.finalizeXCSP2_0(-1, "./chaining-", filter.name() + "-no(" + addNum + ","
					+ mulNum + ")-del(" + filter.addDel() + "," + filter.mulDel()
					+ ").xml");
		}
	}
	...
	public static void experiment1PM(FDstore store, 
		...
		if (result) {
			store.toXCSP2_0();
			store.finalizeXCSP2_0(-1, "./pm-", filter.name() + "-no(" + addNum + ","
					+ mulNum + ")-del(" + filter.addDel() + "," + filter.mulDel()
					+ ").xml");
		}
	}
	...
	public static void experiment1P(FDstore store, 
		...
		if (result) {
			store.toXCSP2_0();
			store.finalizeXCSP2_0(-1, "./al-pipe-", filter.name() + "-no(" + addNum + ","
					+ mulNum + ")-del(" + filter.addDel() + "," + filter.mulDel()
					+ ").xml");
		}
	}
	...
	public static void experiment2P(FDstore store, 
		...
		makeConstraintsPipeline(store, filter, addNum, mulNum);

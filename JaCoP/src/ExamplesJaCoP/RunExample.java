...
public class RunExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			System.out.println("The name of the example is either the class name from ExamplesJaCoP" + 
								" or name of .fzn file from ExamplesMinizinc");
		    System.exit(-1);
        ...
        try {
            ...
            System.err.println("exampleloader: error calling main method in class " + args[0]);
            //e.printStackTrace();
            System.out.println("Make sure you put jdom.jar file inside lib folder.");
            System.exit(-1);
        }

...
public class SendMoreMoney extends Example {
	...
	public void modelBasic() {
		...
		letters[iS] = new FDV(store, "S", 0, 9);
		letters[iE] = new FDV(store, "E", 0, 9);
		letters[iN] = new FDV(store, "N", 0, 9);
		letters[iD] = new FDV(store, "D", 0, 9);
		letters[iM] = new FDV(store, "M", 0, 9);
		letters[iO] = new FDV(store, "O", 0, 9);
		letters[iR] = new FDV(store, "R", 0, 9);
		letters[iY] = new FDV(store, "Y", 0, 9);

		for (Variable x : letters)
			vars.add(x);
		...
		FDV numbersSEND[] = new FDV[4];
		FDV valueSEND = new FDV(store, "SEND", 0, 9999);
		...
		// value is also zero
		numbersSEND[0] = new FDV(store, "v(S)", 0, 9000);
		numbersSEND[1] = new FDV(store, "v(E)", 0, 900);
		numbersSEND[2] = new FDV(store, "v(N)", 0, 90);
		numbersSEND[3] = new FDV(store, "v(D)", 0, 9);
		...
		FDV valueSEinSEND = new FDV(store, "v(SEinSEND)", 0, 9900);
		FDV valueNDinSEND = new FDV(store, "v(NDinSEND)", 0, 99);
		...
		FDV numbersMORE[] = new FDV[4];
		FDV valueMORE = new FDV(store, "MORE", 0, 9999);

		// Creates FDV for each position in MORE with
		// appropriate domain, they all start with zero
		// since a letter could be zero and the position
		// value is also zero
		numbersMORE[0] = new FDV(store, "v(M)", 0, 9000);
		numbersMORE[1] = new FDV(store, "v(O)", 0, 900);
		numbersMORE[2] = new FDV(store, "v(R)", 0, 90);
		numbersMORE[3] = new FDV(store, "v(E)", 0, 9);
		...
		FDV valueMOinMORE = new FDV(store, "v(MOinMORE)", 0, 9900);
		FDV valueREinMORE = new FDV(store, "v(REinMORE)", 0, 99);
		...
		FDV numbersMONEY[] = new FDV[5];
		FDV valueMONEY = new FDV(store, "MONEY", 0, 99999);
		;
		...
		// since a letter could be zero and the position
		// value is also zero
		numbersMONEY[0] = new FDV(store, "v(M)", 0, 90000);
		numbersMONEY[1] = new FDV(store, "v(O)", 0, 9000);
		numbersMONEY[2] = new FDV(store, "v(N)", 0, 900);
		numbersMONEY[3] = new FDV(store, "v(E)", 0, 90);
		numbersMONEY[4] = new FDV(store, "v(Y)", 0, 9);
		...
		FDV valueMOinMONEY = new FDV(store, "v(MOinMONEY)", 0, 99000);
		FDV valueNEinMONEY = new FDV(store, "v(NEinMONEY)", 0, 990);
		FDV valueMONEinMONEY = new FDV(store, "v(MONEinMONEY)", 0, 99990);
	...
	public void model() {
		...
		FDV n = new FDV(store, "N", 0, 9);
		FDV d = new FDV(store, "D", 0, 9);
		FDV m = new FDV(store, "M", 0, 9);
		FDV o = new FDV(store, "O", 0, 9);
		FDV r = new FDV(store, "R", 0, 9);
		FDV y = new FDV(store, "Y", 0, 9);

		// Creating arrays for FDVs
		FDV digits[] = { s, e, n, d, m, o, r, y };
		FDV send[] = { s, e, n, d };
		FDV more[] = { m, o, r, e };
		FDV money[] = { m, o, n, e, y };
		 ...
		 */
		FDV valueSEND = new FDV(store, "v(SEND)", 0, 9999);
		FDV valueMORE = new FDV(store, "v(MORE)", 0, 9999);
		FDV valueMONEY = new FDV(store, "v(MONEY)", 0, 99999);

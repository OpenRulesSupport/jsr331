...
public final class ScheduleActivitiesBudgetOptimal {
    ...
    public void define() throws Exception {
        ...
        Activity[] activities = { masonry, carpentry, roofing, plumbing, ceiling, windows, facade, garden, painting,
                movingIn };
        ...
        /*
         * Building the house now requires $1,000 for each s.activity per day. $13,000
         * are available on the first day. Additional $16,000 becomes available only on
         * day 15.
         */
        // Define resource "Budget"
        int initialBudget = 29000; //13000;
        int totalBudget = initialBudget + 0; //16000;
    ...
    public static void main(String args[]) throws Exception {
        ScheduleActivitiesBudgetOptimal p = new ScheduleActivitiesBudgetOptimal();
        p.define();
        p.solve();
    }
}

	...
	*/
	...
	protected final int test_var_incoming() {
		...
		for (int j = 0; j < _N; j++) {
			...
			//naturalmente relativo alle variabili non basiche. E prendo quello con valore pi� alto. 
	...
	protected final int test_var_incoming_bland() {
		...
		double TBEX_M[]=TBEX[_M];
		for (int j = 0; j < _N; j++) {
			//Cerco la variabile entrante. La candidata dovrebbe essere quella con il costo pi elevato. 

...
public class Problem extends AbstractProblem {
    ...
    ArrayList<LinearIntConstraint> integerConstraints; 
    ArrayList<LinearRealConstraint> realConstraints;
	
	static public final String JSR331_LINEAR_VERSION = "JSR-331 Implementation with SSC Linear Solver";
	...
	public Problem(String name) {
		...
		integerConstraints = new ArrayList<LinearIntConstraint>();
		realConstraints = new ArrayList<LinearRealConstraint>();
	}
	...
	public Constraint post(int[] coefficients, Var[] vars, String oper, int value) {
		...
		integerConstraints.add(new LinearIntConstraint(coefficients,vars,oper,value));
		return null;
...
//		return constraint;
	...
	public Constraint post(int[] coefficients, Var[] vars, String oper, Var var) {
		if (coefficients.length != vars.length)
			throw new RuntimeException("Arrays of coefficients and vars should have the same length");
		integerConstraints.add(new LinearIntConstraint(coefficients,vars,oper,var));
        return null;
...
//		return post(coefs,vars1,oper,value);
	...
	public Constraint post(double[] coefficients, VarReal[] vars, String oper, double value) {
	    ...
	    realConstraints.add(new LinearRealConstraint(coefficients,vars,oper,value));
        return null;
		//return post(coefficients, (ConstrainedVariable[])vars, oper, value);
	}
	...
	public Constraint post(double[] coefficients, ConstrainedVariable[] vars, String oper, double value) {
		...
		return post(coefficients,realVars,oper,value);
//		javax.constraints.impl.Constraint constraint = new javax.constraints.impl.Constraint(this);
//		constraint.setCoefficients(coefficients); 
//		constraint.setVars(vars);
//		constraint.setOper(oper);
...
//		return constraint;
	...
	public Constraint post(double[] coefficients, VarReal[] vars, String oper, VarReal var) {
		if (coefficients.length != vars.length)
			throw new RuntimeException("Arrays of coefficients and vars should have the same length");
		realConstraints.add(new LinearRealConstraint(coefficients, vars, oper, var));
		return null;
...
//		return post(coefs,vars1,oper,value);
	...
	public Constraint post(double[] coefficients, ConstrainedVariable[] vars, String oper, ConstrainedVariable var) {
        ...
        return post(coefficients,realVars,oper,(VarReal)var);
	}
...
//	}
    ...
    public ArrayList<LinearIntConstraint> getIntegerConstraints() {
        return integerConstraints;
    }

    public void setIntegerConstraints(ArrayList<LinearIntConstraint> integerConstraints) {
        this.integerConstraints = integerConstraints;
    }

    public ArrayList<LinearRealConstraint> getRealConstraints() {
        return realConstraints;
    }

    public void setRealConstraints(ArrayList<LinearRealConstraint> realConstraints) {

...
//	static public final double nInf = Double.NEGATIVE_INFINITY;
	...
	/**
	 * Returns the expression: <code>min(1 / [min..max])</code>. Result may be
	...
	/**
	 * Returns the expression: <code>max(1 / [min..max])</code>. Result may be
	 * finite number or +inf.
	 */
	...
	/**
	 * Returns the expression: <code>min([min1..max1]*[min2..max2])</code> where
	 * <code>[min1..max1] is more or equal 0</code>.
	 */
	...
	/**
	 * Returns the expression: <code>max([min1..max1]*[min2..max2])</code> where
	 * <code>[min1..max1] is more or equal to 0</code>.
	 */
	...
	/**
	 * Returns the expression: <code>min([min1..max1]*[min2..max2])</code> where
	 * <code>[min1..max1] is less or equal to 0</code>.
	 */

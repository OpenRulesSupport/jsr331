...
//    return new IntExpConst(constrainer(),_const + value);
   ...
   * @return <code> ConstraintConst(const le value)</code>
   */
   ...
   * @return  (Constraint)(exp gt const -1)
   */
   ...
   * @return (Constraint)(const gt value)
   */
   ...
   * @return (Constraint)(exp lt const)
   */
   ...
   * @return Constraint(const gt value-1)
   */
   ...
   * @return (Constraint)(exp lt const+1)
   */

...
public interface IntExp extends Expression
{
  ...
  */
   ...
   * NOTE: in some cases it is not possible (or feasible) to calculate <code>contains</code> with
...
//  public Constraint equals(FloatExp exp);
  ...
  /**
   * Returns the constraint: <code>(this less value)</code>.
   */
  public Constraint less(int value);

  /**
   * Returns the constraint: <code>(this less exp)</code>.
   */
  public Constraint less(IntExp exp);

  /**
   * Returns the constraint: <code>(this LE value)</code>.
   */
  public Constraint lessOrEqual(int value);

  /**
   * Returns the constraint: <code>(this LE exp)</code>.
   */
  ...
  /**
   * Returns the constraint: <code>(this more value)</code>.
   */
  public Constraint more(int value);

  /**
   * Returns the constraint: <code>(this more exp)</code>.
   */
  public Constraint more(IntExp exp);

  /**
   * Returns the constraint: <code>(this GE value)</code>.
   */
  public Constraint moreOrEqual(int value);

  /**
   * Returns the constraint: <code>(this GE exp)</code>.
   */
   ...
   * <code>((this less rangeMin)*(rangeMin - this) + (this more rangeMax)*(this - rangeMax))</code>.
   */
 ...
 /**
  * Returns the boolean expression: <code>(this lt exp)</code>.
  */
  public IntBoolExp lt(IntExp exp);

 /**
  * Returns the boolean expression: <code>(this lt value)</code>.
  */
 ...
 /**
  * Returns the boolean expression: <code>(this gt exp)</code>.
  */
  public IntBoolExp gt(IntExp exp);

 /**
  * Returns the boolean expression: <code>(this gt value)</code>.
  */
 ...
 /**
  * Returns the boolean expression: <code>(this le exp)</code>.
  */
  public IntBoolExp le(IntExp exp);

 /**
  * Returns the boolean expression: <code>(this le value)</code>.
  */
  public IntBoolExp le(int value);

 /**
  * Returns the boolean expression: <code>(this ge value)</code>.
  */
  public IntBoolExp le(double value);

 /**
  * Returns the boolean expression: <code>(this ge exp)</code>.
  */

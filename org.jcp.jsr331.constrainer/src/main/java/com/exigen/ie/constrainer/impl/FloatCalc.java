...
//    System.out.println(y+"=pow("+x+","+v+")["+Math.pow(x,v)+"]"); // check
   ...
   * where <code>[min1..max1] ge 0</code>.
   */
  ...
  /**
   * Returns the expression: <code>min([min1..max1]*[min2..max2])</code>
   * where <code>[min1..max1] le 0</code>.
   */
  ...
  /**
   * Adjust the expression exp2 so that: <code>min([min1..max1]*[min2..max2]) ge min</code>
   * where <code>[min1..max1] ge 0</code>.
   */
  ...
  /**
   * Adjust the expression exp2 so that: <code>min([min1..max1]*[min2..max2]) le max</code>
   * where <code>[min1..max1] ge 0</code>.
   */
  ...
  /**
   * Adjust the expression exp2 so that: <code>max([min1..max1]*[min2..max2]) le max</code>.
   */

...
public class ScheduleAlternativeResourcesDoNotShare {
	...
	public void define() throws Exception {
		...
		// Carpentry and Painting should not share resources
		carpentry.doNotShareResourcesWith(painting);
	}
	...
	public static void main(String args[]) throws Exception {
		ScheduleAlternativeResourcesDoNotShare schedule = new ScheduleAlternativeResourcesDoNotShare();
		schedule.define();
		schedule.solve();
	}
}

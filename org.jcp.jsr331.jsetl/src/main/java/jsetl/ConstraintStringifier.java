...
class ConstraintStringifier {
     ...
     */
    public static @NotNull String stringify(@NotNull ConstraintClass constraint){
     ...
     */
    public static @NotNull String internalStringify(@NotNull ConstraintClass constraint){
        Objects.requireNonNull(constraint);
     ...
     */
    private static @NotNull String stringify(@NotNull ConstraintClass constraint, @NotNull AConstraintStringifier aConstraintStringifier ){

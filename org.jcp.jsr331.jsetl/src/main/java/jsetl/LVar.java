...
public class LVar extends LObject implements Visitable {
    ...
    */
     ...
     */
    public @NotNull
    ConstraintClass eq(@NotNull Object object) {
        Objects.requireNonNull(object);
        return new ConstraintClass(Environment.eqCode, this, object);
    }
     ...
     */
    public @NotNull
    ConstraintClass neq(@NotNull Object object) {
        Objects.requireNonNull(object);
        return new ConstraintClass(Environment.neqCode, this, object);
    }
}

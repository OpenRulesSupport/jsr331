...
class ConstraintStore implements Iterable<AConstraint>{
     ...
     */    
    protected ConstraintStore(@NotNull SolverClass solver) {
        assert solver != null;
    ...
    /**
     * Returns a new constraint conjunction, namely an object of class {@code ConstraintClass}, containing all
     ...
     */
    protected @NotNull
    ConstraintClass getConstraintAll() {
        ConstraintClass constraint = new ConstraintClass();
     ...
     */
    protected void rewrite(@NotNull AConstraint aConstraint, @NotNull ConstraintClass constraint) {
        assert aConstraint != null;
        assert constraint != null;

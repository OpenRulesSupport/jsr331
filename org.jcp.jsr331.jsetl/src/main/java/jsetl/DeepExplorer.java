 ...
 * Note that only instances of {@code LCollection}, {@code ConstraintClass} and {@code AConstraint} are explored
...
class DeepExplorer{
     ...
     * Note that only nodes that are instances of {@code LObject}, {@code ConstraintClass}
    ...
    private void explorationRouter(@NotNull Object object, @NotNull ExplorationTask explorationTask){
        ...
        else if(object instanceof ConstraintClass)
            explore((ConstraintClass) object, explorationTask);
     ...
     * @param explorationTask task to execute for each node of the exploration tree.
     */
    private void explore(@NotNull ConstraintClass constraint, @NotNull ExplorationTask explorationTask){

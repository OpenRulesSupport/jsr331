...
/**
 * This goal is used by the solver to provided a variable 
 * instantiation goal for the common goal GoalAssignValue.
 * @author J.Feldman
 */
...
public class GoalVarEqValue extends ChocoGoal {
	Var var;
	int value;
	
	public GoalVarEqValue(Solver solver, Var var, int value) {
	...
	public Goal execute() throws Exception {
		...
		cVar.getChocoDomainVar().setVal(value);
		return null;
	}
}
